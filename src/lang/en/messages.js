module.exports = {
	...
	"MSG_EDITED_COUNT"           : "Added files: ",
  "MSG_ISLOCKED"               : "Locked",
	"MSG_WATCHING_START"         : "Watching for changes in",
	"MSG_WATCHING_ADDED"         : "File is added to watcher list.",
	"MSG_WATCHING_REMOVED"       : "File is removed from watcher list.",
	"MSG_SAVED"                  : "saved.",
  "MSG_PATCHED"                : "Patched.",
  "MSG_UNPATCHED"              : "Unpatched.",

	"ERR_NO_SUCH_COMMAND"        : "No such command. For the list of commands enter 'scw help'",
	...
	"ERR_FILE_ALREADY_EXISTS"    : "This file already exists.",
	...
	"ERR_NO_CHANGESFILE"         : "Changes file not found.",
  ...
  "ERR_LOCKED"                 : "The change is locked (unpatched)",
